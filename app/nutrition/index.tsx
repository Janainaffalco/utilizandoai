import { View, Text, StyleSheet, Pressable, ScrollView, Share, ImageComponent } from 'react-native';
        ...
        <View style={styles.containerHeader}>
          <View style={styles.contentHeader}>
            ...
            <Pressable style={styles.buttonShare}>
              <Text style={styles.buttonShareText} onPress={handleShare}>Compartilhar</Text>
            </Pressable>
          </View>
        </View>
